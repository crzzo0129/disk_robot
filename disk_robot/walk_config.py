...
class WalkTaskConfig:
    ...
    def observation_frame_size(self) -> int:
        # body gyro, projected gravity, q-q_stand, qvel, previous action, command
        return 3 + 3 + self.action_size + self.action_size + self.action_size + 3
